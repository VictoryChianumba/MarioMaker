...
from sprites import Generic, Block, Player, Animated, Coin, Particle, Spikes, Tooth, Shell, Cloud
...
class Level:
    ...
    def __init__(self, grid, switch, asset_dict, audio):
        ...
        #additional stuff
        self.particle_surfaces = asset_dict['particle']
        ...
        self.bg_music.set_volume(.4)
        self.bg_music.play(loops = -1)

        self.coin_sound = audio['coin']
        self.coin_sound.set_volume(.3)
    ...
    def get_coins(self):
        ...
        for sprite in collided_coins:
            ...
            Particle(self.particle_surfaces, sprite.rect.center, self.all_sprites)
