...
class Editor:
    def __init__ (self, land_tiles, switch):
        ...
        #create clouds
        self.current_clouds = []
        self.cloud_surfs = import_folder('../graphics/clouds')
        ...
        self.editor_music.set_volume(.4)
   ...
   #support
    ...
    def preview(self):
        ...
        if not self.menu.rect.collidepoint(mouse_pos()):
            ...
            if selected_object:
                 #draw lines around object when hovered over 
    ...
    def display_sky(self, dt):
        ...
        #horizon lines
        if y > 0 :
            horizon_rect1 = pygame.Rect(0,y,WINDOW_WIDTH, 10)
            horizon_rect2 = pygame.Rect(0,y - 6,WINDOW_WIDTH, 4)
            horizon_rect3 = pygame.Rect(0,y - 10,WINDOW_WIDTH, 2)
